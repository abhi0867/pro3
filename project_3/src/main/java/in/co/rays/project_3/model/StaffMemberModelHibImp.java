...
public class StaffMemberModelHibImp implements StaffMemberModelInt {
	...
	public List search(StaffMemberDTO dto, int pageNo, int pageSize) throws ApplicationException {
		...
		try {
			...
			if (dto != null) {
				...
				if (dto.getIdentifier() != null && dto.getIdentifier() > 0) {
					criteria.add(Restrictions.like("Identifier", dto.getIdentifier() + "%"));
				}
	...
	@Override
	public StaffMemberDTO findByName(String name) throws ApplicationException {
		// TODO Auto-generated method stub
		return null;
	}
