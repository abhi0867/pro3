...
*/
	  ...
	  request.setAttribute("fullName", PropertyReader.getValue("error.require",
	  "fullName")); pass = false; }
	  
	  
	  
	  if (DataValidator.isNull(request.getParameter("Joiningdate"))) {
	  request.setAttribute("Joiningdate", PropertyReader.getValue("error.require",
	  " Joiningdate"));
	  ...
	  request.setAttribute("Division", PropertyReader.getValue("error.require",
	  "Division")); pass = false; }
	  
	  if (DataValidator.isNull(request.getParameter("PreviousEmployer"))) {
	  request.setAttribute("PreviousEmployer",
	  PropertyReader.getValue("error.require", "PreviousEmployer")); pass = false;
	  }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		StaffMemberModelInt model = ModelFactory.getInstance().getstaffStaffMemberModel();
